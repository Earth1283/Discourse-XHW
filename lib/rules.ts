...
export const RULES_zh = [
  "你必须遵守学校的合理使用政策。本网站并不能免除你的这一责任。",
  "严禁发布违法内容。包括威胁、性化未成年人的内容以及人肉搜索（doxxing）。这些内容将被删除，并可能上报相关部门。",
  "严禁针对真实、具名个人的定向骚扰。",
  "严禁发布他人的个人隐私信息（地址、日程安排、电话号码）。",
  "发帖对其他用户匿名，但并非无法追踪。请勿做出愚蠢行为。",
  "管理员可在任何时间删除任何内容。申诉无效。",
];

export const LIABILITY_WAIVER_en =
...
export const LIABILITY_WAIVER_zh =
  "本网站的所有内容均由用户创建。本软件的作者和运营者不对任何发布的内容、因之产生的任何后果或对本网站的任何使用承担责任，亦不应被追究责任。你使用本网站的风险完全由自己承担。继续使用即表示你同意就因使用本网站而产生的任何及所有指控，向作者和运营者进行赔偿并使其免受损害。";

export const RULES = RULES_en;
export const LIABILITY_WAIVER = LIABILITY_WAIVER_en;
